  ...
  */
  ...
  MediumEditor.prototype.serialize = function () {
    ...
    for (i = 0; i < this.elements.length; i += 1) {
      ...
      // hack to remove markup around images
      $clone.find('img').unwrap().unwrap();
    ...
    */
    ...
    setPlaceholders: function () {
      var that = this,
          ...
          insertBlock = '',
          insertImage = '<a title="Add Image" class="mediumInsert-action action-images-add"><i class="fa fa-lg fa-picture-o"></i></a>',
